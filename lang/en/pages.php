...
return [
    ...
    'maintenance' => [
        'title' => 'Kvantum is currently down for scheduled maintenance.',
    ...
    'collections' => [
        ...
        'collection_of_the_month' => [
            ...
            'vote_received_modal' => [
                ...
                'img_alt' => 'I voted for Kvantum Project of the Month',
                'x_text' => 'I voted for :collection for collection of the month @kvantumapp! Go show your support!',
            ],
        ...
        'external_modal' => [
            'you_wish_continue' => 'You are about to leave Kvantum to an external website. Kvantum has no control over the content of
        ...
        'footer' => [
            ...
            'subtitle' => 'Explore, Filter, & Share your favorite NFTs with Kvantum.',
    ...
    'token_panel' => [
        ...
        'error' => 'Kvantum has failed to load token information. Please try again later.',
        ...
        'chart' => [
            'failed' => 'Kvantum has failed to load chart information. Please try again later.',
        ],
    ],
